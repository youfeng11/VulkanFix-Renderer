#ifndef SAMPLER_ANISOTROPY_H
#define SAMPLER_ANISOTROPY_H
...
/**
 * Emulates the Vulkan core 1.0 feature 'samplerAnisotropy'
 * on devices whose hardware drivers (e.g. some mobile GPUs) do not natively support anisotropic filtering.
 */
class SamplerAnisotropyModule : public IVulkanLayerModule {
public:
    SamplerAnisotropyModule();
    virtual ~SamplerAnisotropyModule() = default;

    const char* get_name() const override { return "VK_FEATURE_samplerAnisotropy"; }
