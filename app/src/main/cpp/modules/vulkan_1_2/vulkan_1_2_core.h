#ifndef VULKAN_1_2_CORE_H
#define VULKAN_1_2_CORE_H
...
class Vulkan12CoreModule : public IVulkanLayerModule {
public:
    Vulkan12CoreModule();
    ~Vulkan12CoreModule() override = default;

    const char* get_name() const override { return "Vulkan12Core"; }
